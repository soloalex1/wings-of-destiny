...
- também comecei a mexer em algumas coisas da narrativa. a função gameStart (ou algo assim, esqueci) já tem uma descriçãozinha do ambiente and shit.
...
- adicionadas duas Strings ataqueUm e ataqueEspecial pra reutilizar o nome das skills ao longo do código (útil pra batalha funcionar pra todas as classes and shit)
